                    ...
                    <div className="hidden md:flex w-1/2 flex-col justify-between p-12 bg-market-background border-r border-[#E7E5E4] relative overflow-hidden">
                        <div className="relative z-10">
                            ...
                            <h1 className="font-['Lora',serif] text-[36px] font-semibold leading-tight tracking-[0.005em] text-[#1C1917] mb-6">
                                Bắt đầu hành trình <br /> thủ công của bạn.
                            </h1>
                            <p className="text-[18px] text-[#57534E] leading-[1.6]">
                                Tham gia cộng đồng MarketNest ngay hôm nay để khám phá, sưu tầm hoặc chia sẻ những tác phẩm nghệ thuật độc bản của chính bạn với thế giới.
                            </p>
                        </div>
                        ...
                        <div className="w-full max-w-[360px] mx-auto relative z-10">
                            ...
                            <div className="mb-6 text-center md:text-left">
                                ...
                                <p className="text-[14px] text-[#57534E]">
                                    Tạo tài khoản để trải nghiệm MarketNest.
                                </p>
                            </div>
                            ...
                            <form onSubmit={handleSubmit(onRegister)}>
                                ...
                                <div className="flex flex-col mb-4">
                                    ...
                                    <div className="flex gap-2">
                                        <input
                                            ...
                                            className={`flex-1 bg-white border-[1.5px] rounded-[4px] h-[42px] px-[14px] text-[16px] outline-none transition-all duration-200 focus:border-market-primary focus:ring-[3px] focus:ring-market-primary/15 placeholder:text-[#A8A29E] text-[#1C1917] ${errors.email ? 'border-market-error' : 'border-[#D6D3D1]'
                                                }`}
                                            {...register("email", {
                                ...
                                <div className="flex flex-col mb-6">
                                    <label className="text-[13px] font-semibold text-[#1C1917] mb-2">Nhập lại mật khẩu</label>
                                    <input
                                        type="password"
                                ...
                                {/* Login Link */}
                                <div className="mt-6 text-center text-[14px] text-[#57534E]">
                                    Đã có tài khoản?{' '}
